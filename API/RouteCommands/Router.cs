using MTCGame.API.RouteCommands.Messages;
using MTCGame.API.RouteCommands.Users;
using MTCGame.BLL;
    ...
    internal class Router : IRouter
    {
        ...
        public IRouteCommand? Resolve(RequestContext request)
        {
            ...
            IRouteCommand? command = request switch
            {
                ...
                { Method: HttpMethod.Post, ResourcePath: "/profiles"} => new ProfileCommand(_userManager, Deserialize<Profiles>(request.Payload)),
